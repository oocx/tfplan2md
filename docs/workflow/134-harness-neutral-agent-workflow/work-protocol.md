...
**Work Item:** `docs/workflow/134-harness-neutral-agent-workflow/`
**Branch:** `workflow/134-harness-neutral-agent-workflow`
...
- **Artifacts Produced:** `AGENTS.md`, `CLAUDE.md`, `.agents/tiers.json`,
  ...
  `docs/workflow/134-harness-neutral-agent-workflow/{design,tasks,work-protocol}.md`,
