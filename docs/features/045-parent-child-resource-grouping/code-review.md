...
**Location**: [docs/features/045-parent-child-resource-grouping/specification.md](docs/features/045-parent-child-resource-grouping/specification.md#L156-158) and [test-plan.md](docs/features/045-parent-child-resource-grouping/test-plan.md#L35-72)
...
✅ `work-protocol.md` exists in [docs/features/045-parent-child-resource-grouping/](docs/features/045-parent-child-resource-grouping/work-protocol.md)
