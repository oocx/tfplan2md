...
- **Docker:** N/A
- **Changed files:** 3 files (`.github/workflows/release.yml`, `docs/issues/122-musl-build-failure/analysis.md`, `docs/issues/122-musl-build-failure/work-protocol.md`)
...
- **File:** `docs/issues/122-musl-build-failure/work-protocol.md`
