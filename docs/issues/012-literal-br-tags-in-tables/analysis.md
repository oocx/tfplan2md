...
- [docs/features/002-firewall-rule-before-after-display/specification.md](../../features/002-firewall-rule-before-after-display/specification.md)
- [docs/features/002-firewall-rule-before-after-display/architecture.md](../../features/002-firewall-rule-before-after-display/architecture.md)
...
- Updated [docs/features/001-resource-specific-templates/specification.md](../resource-specific-templates.md) to document internal escaping
