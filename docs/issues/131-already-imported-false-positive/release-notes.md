# Pending import no-op status fix (Issue 131)
...
### After
![Pending imports now render as Ready](https://raw.githubusercontent.com/oocx/tfplan2md/v{VERSION}/docs/issues/131-already-imported-false-positive/issue-123-import-ready.png)
