...
**Source Plan Path:** `docs/features/124-azuread-app-role-assignment/uat-plan.json`

**Rendered Output Path:** `docs/features/124-azuread-app-role-assignment/uat-plan.md`
...
tfplan2md docs/features/124-azuread-app-role-assignment/uat-plan.json > docs/features/124-azuread-app-role-assignment/uat-plan.md
```
