...
**Related Documents:**
- Specification: `docs/features/098-azdo-repo-mapping-and-icons/specification.md`
- Architecture: `docs/features/098-azdo-repo-mapping-and-icons/architecture.md`
- Test Plan: `docs/features/098-azdo-repo-mapping-and-icons/test-plan.md`
- Template Feature: `docs/features/086-azdo-principal-mapping/tasks.md` (reference implementation)
...
**Pattern Consistency:** Follow Feature 087 patterns exactly for mapper and formatter implementation.
...
- [ ] Feature reference comment added: `docs/features/098-azdo-repo-mapping-and-icons/specification.md`
...
- Follow the exact pattern used for `AzdoUsers`, `AzdoGroups`, `AzdoProjects` (from Feature 087)
...
- Follow the exact parsing pattern from Feature 087 for `azdoUsers`, `azdoGroups`, `azdoProjects`
...
- Clone implementation from `AzdoUserMapper.cs` (Feature 087) with these changes:
...
- Clone implementation from `AzdoUserIdFormatter.cs` (Feature 087) with these changes:
  - Replace "user" with "repository" throughout
  - Replace 👤 icon with 🗃️ icon
...
- Follow the exact registration pattern from Feature 087 for users, groups, and projects
...
- Follow the exact pattern from Feature 087 for creating user/group/project mappers
...
- Follow the exact pattern from Feature 087 for wiring up user/group/project mappers
...
- Mention that this feature builds on Feature 087 (Azure DevOps Principal Mapping)
...
- **Pattern Matching:** Follow Feature 087 patterns exactly for mapper and formatter
