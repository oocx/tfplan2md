...
- [ ] Standalone .NET 10 console application created in `tools/Oocx.TfPlan2Md.ScreenshotGenerator/`
- [ ] Playwright for .NET integrated for Chromium automation
- [ ] Unit test project created for the screenshot generator
- [ ] CLI accepts all specified options and validates inputs correctly
- [ ] Default viewport (1920x1080) screenshots generate correctly
- [ ] Custom viewport dimensions work correctly via `--width` and `--height`
...
- [ ] Tool can process HTML files generated by feature 027's HTML renderer
- [ ] Unit tests provide good coverage of screenshot generation logic and edge cases
- [ ] Documentation updated to describe the new tool and typical workflows
- [ ] README includes example combining HTML renderer (027) → screenshot generator (028) workflow
