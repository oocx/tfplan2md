# UAT: `--details auto` Mode — Smart Expansion / Default (Azure DevOps)

Expected: Only resources **with code analysis findings** are expanded (3 resources). All others are collapsed.

---

# Terraform Plan Report

Generated by tfplan2md 1.22.1 (d5e3b43) on 2026-02-19 19:50:27 UTC | Terraform 1.14.0
