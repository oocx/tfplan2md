...
**Source Plan Path:** `docs/features/111-azapi-output-values/uat-plan.json`

**Rendered Output Path:** `docs/features/111-azapi-output-values/uat-plan.md`
...
tfplan2md \
  ...
  > docs/features/111-azapi-output-values/uat-plan.md
```
