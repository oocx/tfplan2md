...
Feature 127 adds a dedicated **Output Values** section to `azapi_resource` and
...
Reference: `docs/features/111-azapi-output-values/specification.md`
Architecture: `docs/features/111-azapi-output-values/architecture.md`
Test plan: `docs/features/111-azapi-output-values/test-plan.md`
...
`docs/features/111-azapi-output-values/architecture.md` under
