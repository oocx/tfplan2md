...
**File:** [docs/issues/102-sensitive-info-exposure/work-protocol.md](work-protocol.md)
...
- `docs/issues/102-sensitive-info-exposure/uat-plan.json`
...
`tfplan2md docs/issues/102-sensitive-info-exposure/uat-plan.json > docs/issues/102-sensitive-info-exposure/uat-plan.md`.
...
1. **Developer:** Create `docs/issues/102-sensitive-info-exposure/uat-plan.json` (following the schema in `uat-test-plan.md § Plan Requirements`) and generate `uat-plan.md` from it.
