...
This document breaks down the implementation of Feature 124 — `azuread_app_role_assignment` support — into ordered, independently testable tasks. The feature adds human-readable summary display and GUID-to-name resolution for Azure AD app role assignments in Terraform plan reports.

**Specification:** `docs/features/124-azuread-app-role-assignment/specification.md`
**Architecture:** `docs/features/124-azuread-app-role-assignment/architecture.md`
**Test Plan:** `docs/features/124-azuread-app-role-assignment/test-plan.md`
