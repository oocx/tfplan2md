...
/// Related feature: docs/features/100-terraform-outputs/specification.md.
/// </summary>
...
The `--show-sensitive` flag already exists in `src/Oocx.TfPlan2Md/CLI/CliOptions.cs` (added for Issue 102). No changes needed.
