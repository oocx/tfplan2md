...
Feature 138 redesigns how `relevant_attributes[]` from Terraform 1.14+ plans are surfaced in the markdown report.
...
- Feature Specification: `docs/features/138-inline-relevant-attributes/specification.md`
- ADR-002 (feature 122): `docs/features/130-terraform-1-15-support/adr-002-h2-report-layout.md` — original relevant-attributes placement decision, Option C2 (per-resource footnotes) was rejected at the time.
