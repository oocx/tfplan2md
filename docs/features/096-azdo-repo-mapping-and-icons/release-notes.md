...
![Azure DevOps build definition repository table showing 🗃️ icon on Repo ID and ⎇ icon on Branch](https://raw.githubusercontent.com/oocx/tfplan2md/v1.26.0/docs/features/096-azdo-repo-mapping-and-icons/repo-icons.png)
