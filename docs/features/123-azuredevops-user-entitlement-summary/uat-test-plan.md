...
**Source Plan Path:** `docs/features/123-azuredevops-user-entitlement-summary/uat-plan.json`

**Rendered Output Path:** `docs/features/123-azuredevops-user-entitlement-summary/uat-plan.md`
...
dotnet run --project src/Oocx.TfPlan2Md -- \
  docs/features/123-azuredevops-user-entitlement-summary/uat-plan.json \
  > docs/features/123-azuredevops-user-entitlement-summary/uat-plan.md
```
