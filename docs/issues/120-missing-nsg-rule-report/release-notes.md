...
![Restored separate NSG rule row](https://raw.githubusercontent.com/oocx/tfplan2md/v1.37.1/docs/issues/120-missing-nsg-rule-report/nsg-separate-rule-fix.png)
