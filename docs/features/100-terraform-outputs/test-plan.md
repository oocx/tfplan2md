...
This test plan validates the Terraform Outputs support feature (Feature 100), which adds rendering of Terraform outputs in tfplan2md reports. The feature parses output changes from the Terraform plan JSON, correlates them with configuration metadata, and renders them as tables with intelligent positioning (module outputs within modules, global outputs at the end).

**References:**
- Feature specification: `docs/features/100-terraform-outputs/specification.md`
- Architecture design: `docs/features/100-terraform-outputs/architecture.md`
...
**UAT Test Plan Location:** `docs/features/100-terraform-outputs/uat-test-plan.md`
