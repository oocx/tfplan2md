...
- Update `docs/features.md` to list this feature with a link to `docs/features/130-terraform-1-15-support/`. Update any other top-level feature index that exists (AC-13).
