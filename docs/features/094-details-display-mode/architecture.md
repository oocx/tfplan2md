...
This feature adds a `--details` CLI argument that gives users control over whether resource details blocks (`<details>` HTML elements) are rendered as open or closed in the generated markdown report. The feature specification is documented in `docs/features/094-details-display-mode/specification.md`.
...
/// Related feature: docs/features/094-details-display-mode/specification.md.
/// </remarks>
