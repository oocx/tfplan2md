...
- **Why the snapshot diff is correct**: 
  - New snapshot files for `azapi-update-resource-update.md` and `azapi-update-resource-delete.md` were added to establish baselines for Feature 100.
...
- ✅ Feature references included: `docs/features/097-azapi-update-resource-grouping/specification.md`
