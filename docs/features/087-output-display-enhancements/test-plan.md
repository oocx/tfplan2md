...
This test plan defines the testing strategy for Feature 087: Output Display Enhancements. This feature introduces two improvements to tfplan2md markdown output:
...
**Reference:** `docs/features/087-output-display-enhancements/specification.md`
