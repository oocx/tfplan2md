...
**Acceptance Criteria:**
- [x] Create `docs/features/096-build-definition-tables/uat-plan.json`
...
- [x] Generate `docs/features/096-build-definition-tables/uat-plan.md` using tfplan2md
...
**Notes:**
- Reference: `docs/features/096-build-definition-tables/uat-test-plan.md`
