...
**Source Plan Path:** `docs/features/100-terraform-outputs/uat-plan.json`

**Rendered Output Path:** `docs/features/100-terraform-outputs/uat-plan.md`
...
tfplan2md docs/features/100-terraform-outputs/uat-plan.json \
  -p docs/features/100-terraform-outputs/principal-mapping.json \
  -o docs/features/100-terraform-outputs/uat-plan.md
```
