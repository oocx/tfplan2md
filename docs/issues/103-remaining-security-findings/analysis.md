...
Issue 102 fixed multiple sensitive-value disclosure paths (AzApi body rendering, template-context masking, Azure DevOps variable group secret transitions, and sensitivity hierarchy edge cases).

Issue 110 also identified *non-secret-masking* vulnerabilities and correctness issues that remain open on `main` and can still:
...
Reference: `docs/issues/101-security-analysis/results.md`.
...
- `docs/issues/101-security-analysis/results.md`
- `docs/issues/102-sensitive-info-exposure/analysis.md`
