...
- **Issue Analysis:** `docs/issues/060-parent-child-summary-member-counts/analysis.md`
- **Code Review:** `docs/issues/060-parent-child-summary-member-counts/code-review.md`
- **Work Protocol:** `docs/issues/060-parent-child-summary-member-counts/work-protocol.md`
