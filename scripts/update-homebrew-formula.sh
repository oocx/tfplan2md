...
if [ -z "$MACOS_ARM64_SHA" ] || [ -z "$LINUX_X64_SHA" ] || [ -z "$LINUX_ARM64_SHA" ]; then
...
for sha in "$MACOS_ARM64_SHA" "$LINUX_X64_SHA" "$LINUX_ARM64_SHA"; do
...
sed -i "s/{{LINUX_ARM64_SHA256}}/$LINUX_ARM64_SHA/g" "$FORMULA_FILE"
