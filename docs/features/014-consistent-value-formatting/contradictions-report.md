...
This appears to be an intentional design choice per the original feature spec for NSG templates, which stated: "Headers use plain text for names" (see `docs/features/016-nsg-security-rule-template/specification.md`).
