...
> **Background:** Feature 098 implemented all the underlying infrastructure (`BuildDefinitionViewModelFactory`, `BuildDefinitionFormatters`, view models) but stopped short of registering a dedicated renderer. The `AzureDevOpsDelegatingRenderer` (generic fallback) was left in place. This issue completes Feature 098 by creating and registering `BuildDefinitionRenderer`.
...
- [Feature 098: Azure DevOps Build Definition Tables](../../features/096-build-definition-tables/specification.md) — original infrastructure implementation
- [Issue 095: Sensitive Attribute Disclosure](../095-sensitive-attribute-disclosure/analysis.md) — hierarchical sensitivity check that caused the bleed
