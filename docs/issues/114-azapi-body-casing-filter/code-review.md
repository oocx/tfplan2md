# Code Review: azapi Body Casing Filter (Issue 115)
...
The issue `docs/issues/114-azapi-body-casing-filter/analysis.md` defines the root cause and
...
1. **Incorrect issue path in comments** — Multiple source files reference
   ...
   The actual path is `docs/issues/114-azapi-body-casing-filter/`.
