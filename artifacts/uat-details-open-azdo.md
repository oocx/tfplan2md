# UAT: `--details open` Mode — All Resources Expanded (Azure DevOps)

Expected: All `<details>` blocks render **expanded** (`open` attribute present on all resource containers).

---

# Terraform Plan Report

Generated by tfplan2md 1.22.1 (d5e3b43) on 2026-02-19 19:50:26 UTC | Terraform 1.14.0
