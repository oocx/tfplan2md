...
Reviewed the implementation of Feature 127, which surfaces computed (`after_unknown`) Terraform
...
The UAT test plan at `docs/features/106-known-after-apply-rendering/uat-test-plan.md` § Artifacts
explicitly states:

> **Rendered Output Path:** `docs/features/106-known-after-apply-rendering/uat-plan.md`
...
dotnet run --project src/Oocx.TfPlan2Md/Oocx.TfPlan2Md.csproj -- \
  docs/features/106-known-after-apply-rendering/uat-plan.json \
  > docs/features/106-known-after-apply-rendering/uat-plan.md
```
...
`README.md` first):
```bash
git add docs/features.md README.md docs/features/106-known-after-apply-rendering/work-protocol.md
...
Feature 127. Consider adding it for navigability.
