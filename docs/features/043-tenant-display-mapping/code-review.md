...
- Feature/spec references included (e.g., "Related feature: docs/features/043-tenant-display-mapping/specification.md")
...
Verified `work-protocol.md` in `docs/features/043-tenant-display-mapping/`:
