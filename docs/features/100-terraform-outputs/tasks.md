...
This document breaks down the implementation of Feature 100: Terraform Outputs Support into discrete, actionable tasks. The feature adds rendering of Terraform outputs in tfplan2md reports, with support for module outputs (positioned within module sections) and global outputs (positioned at the end), sensitive value masking, computed value handling, and automatic display name mapping integration.

**References:**
- Specification: `docs/features/100-terraform-outputs/specification.md`
- Architecture: `docs/features/100-terraform-outputs/architecture.md`
- Test Plan: `docs/features/100-terraform-outputs/test-plan.md`
...
- Access `_showSensitive` field from `ReportModelBuilder` (already exists from Issue 102)
...
- [ ] CLI help text verified for `--show-sensitive` flag (already exists from Issue 102)
