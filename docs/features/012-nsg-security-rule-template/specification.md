...
- [x] Documentation updated in [docs/features.md](../features.md) and [docs/features/001-resource-specific-templates/specification.md](resource-specific-templates.md)
