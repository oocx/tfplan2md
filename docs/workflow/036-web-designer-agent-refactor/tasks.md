...
|---:|---|---|---|---|---|---|---|---|
| 1 | Remove duplicate DoD + reconcile contradictions | maintainer feedback | ⬜ Not started | Two DoD sections + overlapping rules increases confusion and token waste | High | Med | Low | Keep the strict “Definition of Done (CRITICAL)” only; delete/merge the later generic DoD section |
| 2 | Consolidate “Phases” vs “Workflow” guidance | maintainer feedback | ⬜ Not started | Two different process descriptions cause ambiguity and slow the agent | High | Med | Med | Keep one lightweight workflow with explicit “wait for approval” guardrails |
...
| 5 | Prune/triage “Context to Read” list | maintainer feedback | ⬜ Not started | Too many “must read” files increases context cost; many are situational | High | Low | Low | Split into “Always read (top 3–5)” vs “Read when relevant” |
