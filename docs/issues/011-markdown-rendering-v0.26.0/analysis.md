...
Version 0.26.0 was released with the goal of implementing markdown quality validation and linting (feature: docs/features/010-markdown-quality-validation/specification.md), but it still produces markdown that fails validation and renders incorrectly.
...
- **Feature Spec:** [docs/features/010-markdown-quality-validation/specification.md](../../features/010-markdown-quality-validation/specification.md)
