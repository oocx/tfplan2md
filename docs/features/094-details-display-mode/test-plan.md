...
**Specification:** `docs/features/094-details-display-mode/specification.md`
...
A separate UAT test plan will be created in: `docs/features/094-details-display-mode/uat-test-plan.md`
