...
**Location:** `docs/issues/104-open-action-support/work-protocol.md`
...
**File:** `docs/issues/104-open-action-support/work-protocol.md`
...
1. **Maintainer:** Add missing Developer agent entry to `docs/issues/104-open-action-support/work-protocol.md`
