...
Generated by tfplan2md 1.42.1 (35cb0b9) on 2026-04-30 20:39:47 UTC | Terraform 1.14.2
...
**Build Definition:** <code>example-pipeline</code>
...
| -------- | -------------- |
| `azuredevops_git_repository.example` | `default_branch` |
| `azuredevops_build_definition.example2` | `id` |
