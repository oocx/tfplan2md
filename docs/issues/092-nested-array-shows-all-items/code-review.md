...
- Issue: `docs/issues/092-nested-array-shows-all-items/analysis.md`
...
✅ **Excellent:** The release notes at `docs/issues/092-nested-array-shows-all-items/release-notes.md` are comprehensive:
...
- **Release notes** are already prepared at `docs/issues/092-nested-array-shows-all-items/release-notes.md`
