...
- **Release Notes**: The release workflow uses the most recent user-facing `release-notes.md` it can find under `docs/features/**/release-notes.md`, `docs/issues/**/release-notes.md`, or `docs/workflow/**/release-notes.md`. If none is present, it falls back to changelog extraction.
