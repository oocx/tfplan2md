...
- `docs/issues/102-sensitive-info-exposure/` — prior work on `SensitivityHelper` for resource attribute masking
- `docs/issues/095-sensitive-attribute-disclosure/` — hierarchical sensitivity detection
