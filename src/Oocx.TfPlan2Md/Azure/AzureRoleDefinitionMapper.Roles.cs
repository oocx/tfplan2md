...
public static partial class AzureRoleDefinitionMapper
{
    private static readonly FrozenDictionary<string, string> Roles = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["0336e1d3-7a87-462b-b6db-342b63f7802c"] = "Azure Red Hat OpenShift Cluster Ingress Operator",
        ["0358943c-7e01-48ba-8889-02cc51d78637"] = "Azure Red Hat OpenShift Machine API Operator",
        ...
        ["09267e11-2e06-40b5-8fe4-68cea20794c9"] = "Azure Device Registry Credentials Contributor",
        ...
        ["0ad04412-c4d5-4796-b79c-f76d14c8d402"] = "Durable Task Data Contributor",
        ...
        ["0d7aedc0-15fd-4a67-a412-efad370c947e"] = "Azure Red Hat OpenShift File Storage Operator",
        ...
        ["11076f67-66f6-4be0-8f6b-f0609fd05cc9"] = "Azure Batch Account Reader",
        ...
        ["1a40e87e-6645-48e0-b27a-0b115d849a20"] = "Chaos Studio Operator",
        ["1afdec4b-e479-420e-99e7-f82237c7c5e6"] = "Azure Kubernetes Service Cluster Monitoring User",
        ["1b32c00b-7eff-4c22-93e6-93d11d72d2d8"] = "Container Apps ManagedEnvironments Reader",
        ...
        ["289d8817-ee69-43f1-a0af-43a45505b488"] = "Azure Kubernetes Service Namespace Contributor",
        ["28bf596f-4eb7-45ce-b5bc-6cf482fec137"] = "Locks Contributor",
        ["29093635-9924-4f2c-913b-650a12949526"] = "Container Registry Credential Set Reader",
        ["29e2da8a-229c-4157-8ae8-cc72fc506b74"] = "Chaos Studio Reader",
        ["29fe4964-1e60-436b-bd3a-77fd4c178b3c"] = "Azure Batch Account Contributor",
        ...
        ["2bed379c-9fba-455b-99e4-6b911073bcf2"] = "Compute Fleet Contributor",
        ["2c56ea50-c6b3-40a6-83c0-9d98858bc7d2"] = "Schema Registry Reader",
        ["2cc479cb-7b4d-49a8-b449-8c00fd0f0a4b"] = "Web Plan Contributor",
        ["2efddaa5-3f1f-4df3-97df-af3f13818f4c"] = "Container Registry Repository Contributor",
        ...
        ["358470bc-b998-42bd-ab17-a7e34c199c0f"] = "Container Apps Contributor",
        ...
        ["3bc748fc-213d-45c1-8d91-9da5725539b9"] = "Container Registry Contributor and Data Access Configuration Administrator",
        ...
        ["41e04612-9dac-4699-a02b-c82ff2cc3fb5"] = "Grafana Limited Viewer",
        ...
        ["4436bae4-7702-4c84-919b-c4069ff25ee2"] = "Azure Red Hat OpenShift Service Operator",
        ...
        ["48e5e92e-a480-4e71-aa9c-2778f4c13781"] = "Azure Batch Job Submitter",
        ...
        ["4e3d2b60-56ae-4dc6-a233-09c8e5a82e68"] = "Container Apps Jobs Contributor",
        ...
        ["547f7f0a-69c0-4807-bd9e-0321dfb66a84"] = "Azure Device Registry Onboarding",
        ["56328988-075d-4c6a-8766-d93edd6725b6"] = "API Management Workspace API Developer",
        ["577a9874-89fd-4f24-9dbd-b5034d0ad23a"] = "Container Registry Data Importer and Data Reader",
        ["57cc5028-e6a7-4284-868d-0611c5923f8d"] = "Container Apps ManagedEnvironments Contributor",
        ["582fc458-8989-419f-a480-75249bc5db7e"] = "Reservations Reader",
        ["58a3b984-7adf-4c20-983a-32417c86fbc8"] = "DICOM Data Owner",
        ["59a618e3-3c9a-406e-9f03-1a20dd1c55f1"] = "Chaos Studio Target Contributor",
        ...
        ["5b7237c5-45e1-49d6-bc18-a1f62f400748"] = "Azure Red Hat OpenShift Disk Storage Operator",
        ...
        ["5c2d7e57-b7c2-4d8a-be4f-82afa42c6e95"] = "Azure Managed Grafana Workspace Contributor",
        ...
        ["5d9bac3f-34b2-432f-bde5-78aa8e73ce6b"] = "Storage File Data SMB Take Ownership",
        ...
        ["69b07be0-09bf-439a-b9a6-e73de851bd59"] = "Container Registry Configuration Reader and Data Access Configuration Reader",
        ["6aaa78f1-f7de-44ca-8722-c64a23943cae"] = "Azure Batch Data Contributor",
        ...
        ["6f4fe6fc-f04f-4d97-8528-8bc18c848dca"] = "Container Apps ConnectedEnvironments Contributor",
        ...
        ["754c1a27-40dc-4708-8ad4-2bffdeee09e8"] = "Azure File Sync Reader",
        ["76153a9e-0edb-49bc-8e01-93c47e6b5180"] = "DevOps Infrastructure Contributor",
        ...
        ["765a04e0-5de8-4bb2-9bf6-b2a30bc03e91"] = "Storage File Delegator",
        ["78e4b983-1a0b-472e-8b7d-8d770f7c5890"] = "DeID Data Owner",
        ...
        ["7ee386e9-84f0-448e-80a6-f185f6533131"] = "Storage Queue Delegator",
        ...
        ["80d0d6b0-f522-40a4-8886-a5a11720c375"] = "Durable Task Worker",
        ...
        ["83f80186-3729-438c-ad2d-39e94d718838"] = "Service Fabric Managed Cluster Contributor",
        ["8508508a-4469-4e45-963b-2518ee0bb728"] = "AgFood Platform Service Contributor",
        ["85a2d0d9-2eba-4c9c-b355-11c2cc0788ab"] = "Compute Gallery Artifacts Publisher",
        ...
        ["8b32b316-c2f5-4ddf-b05b-83dacd2d08b5"] = "Azure Red Hat OpenShift Image Registry Operator",
        ...
        ["965033a5-c8eb-4f35-b82f-fef460a3606d"] = "Storage Table Delegator",
        ...
        ["a1f96423-95ce-4224-ab27-4e3dc72facd4"] = "Azure Red Hat OpenShift Cloud Controller Manager",
        ...
        ["a5c3590a-3a1a-4cd4-9648-ea0a32b15137"] = "Azure Device Registry Contributor",
        ...
        ["af61e8fc-2633-4b95-bed3-421ad6826515"] = "Container Apps SessionPools Reader",
        ["af6a70f8-3c9f-4105-acf1-d719e9fca4ca"] = "Elastic SAN Reader",
        ["af854a69-80ce-4ff7-8447-f1118a2e0ca8"] = "Healthcare Agent Editor",
        ...
        ["b6efc156-f0da-4e90-a50a-8c000140b017"] = "Service Fabric Cluster Contributor",
        ...
        ["b9331d33-8a36-4f8c-b097-4f54124fdb44"] = "Managed Application Publisher Operator",
        ...
        ["be7a6435-15ae-4171-8f30-4a343eff9e8f"] = "Azure Red Hat OpenShift Network Operator",
        ["befefa01-2a29-4197-83a8-272ff33ce314"] = "DNS Zone Contributor",
        ["bf94e731-3a51-4a7c-8c54-a1ab9971dfc1"] = "Container Registry Transfer Pipeline Contributor",
        ["bfb1c7d2-fb1a-466b-b2ba-aee63b92deaf"] = "Web PubSub Service Reader",
        ["bfdb9389-c9a5-478a-bb2f-ba9ca092c3c7"] = "Container Registry Repository Catalog Lister",
        ...
        ["c1410b24-3e69-4857-8f86-4d0a2e603250"] = "Quantum Workspace Data Contributor",
        ...
        ["c357b964-0002-4b64-a50d-7a28f02edc52"] = "Container Registry Cache Rule Reader",
        ...
        ["c9f76ca8-b262-4b10-8ed2-09cf0948aa35"] = "Azure Kubernetes Service Namespace User",
        ...
        ["cf7c76d2-98a3-4358-a134-615aa78bf44d"] = "Compute Gallery Image Reader",
        ...
        ["d5adeb5b-107f-4aca-99ea-4e3f4fc008d5"] = "Container Apps ConnectedEnvironments Reader",
        ["d6a5505f-6ebb-45a4-896e-ac8274cfc0ac"] = "Durable Task Data Reader",
        ...
        ["de2b316d-7a2c-4143-b4cd-c148f6a355a1"] = "Azure Kubernetes Fleet Manager Hub Agent Role",
        ["de754d53-652d-4c75-a67f-1e48d8b49c97"] = "Service Group Reader",
        ["df87f177-bb12-4db1-9793-a413691eff94"] = "Container Registry Cache Rule Administrator",
        ["dfce44e4-17b7-4bd1-a6d1-04996ec95633"] = "Device Provisioning Service Data Contributor",
        ["dfce8971-25e3-42e3-ba33-6055438e3080"] = "VM Restore Operator",
        ...
        ["eb5a76d5-50e7-4c33-a449-070e7c9c4cf2"] = "Healthcare Agent Reader",
        ...
        ["edd66693-d32a-450b-997d-0158c03976b0"] = "Container Apps Jobs Reader",
        ...
        ["ef318e2a-8334-4a05-9e4a-295a196c6a6e"] = "Azure Red Hat OpenShift Federated Credential",
        ["f07febfe-79bc-46b1-8b37-790e26e6e498"] = "Cognitive Services Language Owner",
        ["f094fb07-0703-4400-ad6a-e16dd8000e14"] = "Container Registry Credential Set Administrator",
        ["f1082fec-a70f-419f-9230-885d2550fb38"] = "Healthcare Agent Admin",
        ...
        ["f3bd1b5c-91fa-40e7-afe7-0c11d331232c"] = "Container Apps Operator",
        ...
        ["f6e92014-8af2-414d-9948-9b1abf559285"] = "Arc Gateway Manager",
        ...
        ["fb382eab-e894-4461-af04-94435c366c3f"] = "Container Registry Tasks Contributor",
        ...
        ["fe86443c-f201-4fc4-9d2a-ac61149fbda0"] = "App Configuration Contributor",
