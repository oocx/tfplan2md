...
public static partial class ScribanHelpers
{
        ...
        RenderTargets.DetailsDisplayMode detailsDisplayMode = RenderTargets.DetailsDisplayMode.Auto)
    {
        ...
        scriptObject.Import("format_own_attribute_value_table", new Func<string?, string?, string?, string>((name, value, provider) => FormatOwnAttributeValueTableWithRegistry(name, value, provider, valueFormatterRegistry, iconProviderRegistry)));
