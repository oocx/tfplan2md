...
- [ ] Documentation ([docs/features.md](docs/features.md) and [docs/features/resource-specific-templates.md](docs/features/resource-specific-templates.md)) is updated to reflect the new behavior with example output
