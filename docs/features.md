...
- **Border styling**: 1px solid #f0f0f0 border with 12px padding (applied as inline styles)
- **Platform-specific handling**:
  - **Azure DevOps**: Preserves inline styles for visible borders
...
Each resource appears in a lightly bordered box, making it easy to scan multiple resources and understand the structure at a glance.
