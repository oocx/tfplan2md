...
- ✅ Feature references included (e.g., "Related feature: docs/features/086-azdo-principal-mapping/specification.md")
...
- ✅ `work-protocol.md` exists in `docs/features/086-azdo-principal-mapping/`
