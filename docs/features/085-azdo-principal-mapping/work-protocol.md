...
- **Artifacts Produced:**
  - `docs/features/085-azdo-principal-mapping/uat-plan.md` - **Real tfplan2md output** (generated by CLI tool)
  - `docs/features/085-azdo-principal-mapping/uat-plan.json` - Terraform plan test data (10 Azure DevOps resources)
  - `docs/features/085-azdo-principal-mapping/uat-mapping.json` - Principal mapping file with azdo sections
