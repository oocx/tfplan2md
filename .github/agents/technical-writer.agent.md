...
tools: ['search', 'edit', 'read/readFile', 'search/listDirectory', 'search/codebase', 'search/usages', 'search/changes', 'read/problems', 'web/fetch', 'web/githubRepo', 'github/*', 'mcp-mermaid/*', 'microsoftdocs/mcp/*', 'github.vscode-pull-request-github/copilotCodingAgent', 'todo']
handoffs:
...
- Can validate documentation changes locally
...
- Cannot validate documentation locally - rely on CI checks
