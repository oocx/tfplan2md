...
This bug-fix plan translates the requirements from [analysis.md](/home/re/git/private/tfplan2md/docs/issues/120-missing-nsg-rule-report/analysis.md), [architecture.md](/home/re/git/private/tfplan2md/docs/issues/120-missing-nsg-rule-report/architecture.md), [test-plan.md](/home/re/git/private/tfplan2md/docs/issues/120-missing-nsg-rule-report/test-plan.md), and [uat-test-plan.md](/home/re/git/private/tfplan2md/docs/issues/120-missing-nsg-rule-report/uat-test-plan.md) into implementation-ready user stories.
...
**Acceptance Criteria:**
- [ ] `docs/issues/120-missing-nsg-rule-report/uat-plan.json` is added with focused NSG scenarios for separate `create`, `update`, `delete`, and mixed inline plus separate rules.
- [ ] `docs/issues/120-missing-nsg-rule-report/uat-plan.md` is generated from that focused plan through the normal tfplan2md pipeline.
