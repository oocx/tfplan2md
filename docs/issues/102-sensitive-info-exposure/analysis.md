...
Reference: the aggregated findings in `docs/issues/101-security-analysis/results.md`.
...
- The attribute-level sensitivity logic references a prior issue: `docs/issues/095-sensitive-attribute-disclosure/analysis.md`.
