# Code Review: Fix ArgumentNullException for Missing `resource_changes` (Issue 129)
...
| Item | Status | Notes |
|---|---|---|
| `work-protocol.md` exists | ✅ | `docs/issues/121-argument-null-source/work-protocol.md` present |
