...
| 🔄 | `allow-dns` | <code>UDP</code> | - `10.1.1.0/24`<br>+ `10.1.1.0/24, 10.1.2.0/24` | <code>168.63.129.16</code> | <code>53</code> | <code>DNS to Azure</code> |
| 🔄 | `allow-api` | <code>TCP</code> | <code>10.1.1.0/24</code> | - `10.1.2.0/24`<br>+ `10.2.2.0/24` | - `8443`<br>+ `8443, 9443` | <code>API tier</code> |
