...
**Feature Specification:** `docs/features/094-details-display-mode/specification.md`
**Architecture:** `docs/features/094-details-display-mode/architecture.md`
**Test Plan:** `docs/features/094-details-display-mode/test-plan.md`
...
- [ ] Documentation references the feature specification (docs/features/094-details-display-mode/specification.md)
