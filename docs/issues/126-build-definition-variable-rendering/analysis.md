...
- Feature `094-build-definition-tables`: Implemented `BuildDefinitionViewModelFactory` and all
  ...
  Work Protocol: `docs/features/096-build-definition-tables/work-protocol.md`.

### Related Issues

- `docs/issues/095-sensitive-attribute-disclosure/analysis.md` — the hierarchical sensitivity
  check was added to prevent the inverse problem (secrets leaking in other providers).
- `docs/issues/102-sensitive-info-exposure/analysis.md` — further sensitive value hardening.
