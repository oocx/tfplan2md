...
**Work Item:** `docs/workflow/137-fix-release-build-slsa/`
...
- **Artifacts Produced:** `.github/workflows/release.yml`, `docs/workflow/137-fix-release-build-slsa/release-notes.md`, `docs/workflow/137-fix-release-build-slsa/work-protocol.md`
