...
Reference: [docs/features/025-aot-trimmed-image/specification.md](docs/features/025-aot-trimmed-image/specification.md)
...
**Acceptance Criteria:**
- [x] `docs/features/025-aot-trimmed-image/specification.md` is updated with final metrics (14.7MB, musl, FROM scratch).
