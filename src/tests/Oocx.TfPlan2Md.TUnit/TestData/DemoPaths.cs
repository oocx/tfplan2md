...
public static class DemoPaths
{
    ...
    /// <summary>
    /// Gets the path to the Azure AD app role assignment test plan JSON file.
    /// </summary>
    public static string AzureAdAppRoleAssignmentPlanPath => Path.Combine(RepositoryRoot, "src", "tests", "Oocx.TfPlan2Md.TUnit", "TestData", "azuread-app-role-assignment-plan.json");
