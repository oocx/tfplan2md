...
**Source Plan Path:** `docs/issues/120-missing-nsg-rule-report/uat-plan.json`

**Rendered Output Path:** `docs/issues/120-missing-nsg-rule-report/uat-plan.md`
...
```bash
tfplan2md docs/issues/120-missing-nsg-rule-report/uat-plan.json --output docs/issues/120-missing-nsg-rule-report/uat-plan.md
```
...
1. Developer creates `docs/issues/120-missing-nsg-rule-report/uat-plan.json` with the focused NSG scenarios above.
2. Developer generates `docs/issues/120-missing-nsg-rule-report/uat-plan.md` from that plan.
...
In the **feature-specific report** using `docs/issues/120-missing-nsg-rule-report/uat-plan.md`:
