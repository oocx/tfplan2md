...
**Source Plan Path:** `docs/features/096-build-definition-tables/uat-plan.json`

**Rendered Output Path:** `docs/features/096-build-definition-tables/uat-plan.md`
...
- **Rationale:** This specific plan demonstrates all aspects of Feature 098 - build definition table rendering, secret masking, and semantic variable diffing
...
cd docs/features/096-build-definition-tables/
