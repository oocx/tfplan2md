...
- Related issue reference: `docs/issues/060-parent-child-summary-member-counts/analysis.md`
...
- **UAT report already created:** `docs/issues/060-parent-child-summary-member-counts/uat-report.md`
...
**Issue:** #447 (docs/issues/060-parent-child-summary-member-counts/)
