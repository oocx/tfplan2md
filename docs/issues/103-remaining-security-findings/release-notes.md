...
Five security and correctness issues identified in the Issue 110 security audit are resolved in this release. All five had already been tracked as open after Issue 102 addressed the sensitive-value masking category; this release closes the remaining findings.
