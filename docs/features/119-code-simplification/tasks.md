...
Feature 127 addresses 16 code-quality findings grouped into five categories: duplicate code,
...
References:
- Specification: `docs/features/119-code-simplification/specification.md`
- Architecture: `docs/features/119-code-simplification/architecture.md`
...
`docs/features/119-code-simplification/architecture.md`.
