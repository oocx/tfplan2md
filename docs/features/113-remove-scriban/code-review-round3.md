...
The reflection removal and `JsonEmbedGenerator` go beyond the original Feature 113 specification
...
|----------|---------|-------|
| `docs/features.md` | ✅ | Feature 113 section added (lines 2939–2964); rendering section updated with Feature 113 reference |
