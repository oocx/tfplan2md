...
**Artifacts Produced:**
- `docs/issues/090-no-op-parent-hides-child-changes/release-notes.md` - User-facing release notes explaining the bug, impact, fix, and affected resource types
...
**Artifacts Produced:**
- `docs/issues/090-no-op-parent-hides-child-changes/code-review.md` - Comprehensive code review report with approval
...
- ✅ Release Notes: Complete in `docs/issues/090-no-op-parent-hides-child-changes/release-notes.md`
