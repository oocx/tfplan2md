...
**Source Plan Path:** `docs/features/087-output-display-enhancements/uat-plan.json`

**Rendered Output Path:** `docs/features/087-output-display-enhancements/uat-plan.md`
...
tfplan2md docs/features/087-output-display-enhancements/uat-plan.json \
  --debug \
