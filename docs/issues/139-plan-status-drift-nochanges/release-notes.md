# Plan status / drift regressions fixed (Issue 139)
...
![No-change plan: no false non-applyable warning](https://raw.githubusercontent.com/oocx/tfplan2md/v1.45.2/docs/issues/139-plan-status-drift-nochanges/status-no-warning.png)
...
![Actionable non-applyable plan: warning still rendered](https://raw.githubusercontent.com/oocx/tfplan2md/v1.45.2/docs/issues/139-plan-status-drift-nochanges/status-with-warning.png)
