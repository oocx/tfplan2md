...
| 2 | Improve developer progress visibility | Feature 027 retrospective | 🟡 In progress | Maintainer feedback: progress and next steps were unclear during long dev sessions. | High | Low | Low | Update `.github/agents/developer.agent.md` to require periodic progress updates and stronger `todo` cadence. |
...
- **Option 1 (Best balance of effort/impact):** **2** — High impact on perceived workflow quality with minimal change.
