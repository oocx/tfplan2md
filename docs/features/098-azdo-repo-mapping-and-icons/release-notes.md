...
![Azure DevOps build definition repository table showing 🗃️ icon on Repo ID and ⎇ icon on Branch](https://raw.githubusercontent.com/oocx/tfplan2md/v1.26.0/docs/features/098-azdo-repo-mapping-and-icons/repo-icons.png)
...
- **Consistent with Feature 087**: Repository mapping follows the same architecture as Azure DevOps principal mapping (users, groups, projects)
...
- **Feature specification**: [docs/features/098-azdo-repo-mapping-and-icons/specification.md](specification.md)
- **Architecture**: [docs/features/098-azdo-repo-mapping-and-icons/architecture.md](architecture.md)
- **Test plan**: [docs/features/098-azdo-repo-mapping-and-icons/test-plan.md](test-plan.md)
- **User guide**: [README.md](../../../README.md) (principal mapping section)
- **Features list**: [docs/features.md](../../features.md)

## 🙏 Acknowledgments

This feature extends the principal mapping pattern established in Feature 087 (Azure DevOps Principal Mapping) to include repository entities, and adds semantic icons to improve visual scanning of Azure DevOps resources in Terraform plans.
