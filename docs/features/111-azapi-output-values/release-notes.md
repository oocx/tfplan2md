...
![Update resource with Output Values section](https://raw.githubusercontent.com/oocx/tfplan2md/v1.32.0/docs/features/111-azapi-output-values/azapi-output-update.png)

### Delete operation — Output Values with sensitive field masking

![Delete resource with Output Values (sensitive)](https://raw.githubusercontent.com/oocx/tfplan2md/v1.32.0/docs/features/111-azapi-output-values/azapi-output-delete.png)
