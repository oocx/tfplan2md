...
public class CliParserTests
{
    ...
    [Test]
    public void Parse_DetailsAuto_SetsDetailsDisplayModeOpenOnWarnings()
    {
        // Arrange
        ...
        // Assert
        options.DetailsDisplayMode.Should().Be(DetailsDisplayMode.OpenOnWarnings);
    }

    [Test]
    public void Parse_DetailsDefault_IsOpenOnWarnings()
    {
        // Arrange
        var args = Array.Empty<string>();
    ...
    [Test]
    public void Parse_DetailsWithoutValue_ThrowsCliParseException()
    {
        // Arrange
