...
- Specification: [docs/features/130-terraform-1-15-support/specification.md](specification.md) §§ FR-H1.1, FR-H1.2, FR-H2.1–FR-H2.3, FR-M2.1–FR-M2.3, NFR-1, NFR-5
- Analysis: [docs/features/130-terraform-1-15-support/analysis.md](analysis.md)
