...
**Work Item:** `docs/features/127-bitbucket-render-target/`
**Branch:** `feature/127-bitbucket-render-target`
...
- **Artifacts Produced:** `docs/features/127-bitbucket-render-target/architecture.md`, `docs/features/127-bitbucket-render-target/work-protocol.md`
