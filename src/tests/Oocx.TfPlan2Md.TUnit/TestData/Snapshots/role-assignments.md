...
<details style="margin-bottom:12px; border:1px solid rgb(var(--palette-neutral-10, 153, 153, 153)); padding:12px;">
<summary>➕ azurerm_role_assignment <b><code>subscription_scope_mapped</code></b> — <code>👤 11111111-1111-1111-1111-111111111111</code> → <code>🛡️ Contributor</code> on subscription <code>🔑 Production</code></summary>
<br>

| Attribute | Value |
| ----------- | ------- |
| scope | subscription `🔑 Production (sub-123)` |
| role_definition_id | `🛡️ Contributor` (`b24988ac-6180-42a0-ab88-20f7382dd24c`) |
| principal_id | `👤 11111111-1111-1111-1111-111111111111 (User)` [`11111111-1111-1111-1111-111111111111`] |
| principal_type | `👤 User` |
| name | `🆔 ra-sub-mapped` |
...
<details style="margin-bottom:12px; border:1px solid rgb(var(--palette-neutral-10, 153, 153, 153)); padding:12px;">
<summary>➕ azurerm_role_assignment <b><code>subscription_scope_unmapped</code></b> — <code>👥 22222222-2222-2222-2222-222222222222</code> → <code>🛡️ Reader</code> on subscription <code>🔑 sub-unmapped-id</code></summary>
<br>
