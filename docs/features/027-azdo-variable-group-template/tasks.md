...
- [ ] Feature reference comment added: `Related feature: docs/features/027-azdo-variable-group-template/specification.md`
...
- [ ] New property added to `ResourceChangeModel` class:
  ...
  /// Related feature: docs/features/027-azdo-variable-group-template/specification.md
  /// </summary>
