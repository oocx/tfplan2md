...
public class MarkdownRendererTests
{
    ...
    public void Render_ValidPlan_ContainsSummarySection()
    {
        ...
        markdown.Should().Contain("## Summary")
            .And.Contain($"{ActionIcons.Add}{Nbsp}Add")
            .And.Contain($"{ActionIcons.Update}{Nbsp}Change")
            .And.Contain($"{ActionIcons.Delete}{Nbsp}Destroy");
    }

    [Test]
    public void Render_Summary_UsesNonBreakingSpaceBetweenIconAndLabel()
    {
        // Arrange
        var json = File.ReadAllText("TestData/azurerm-azuredevops-plan.json");
        var plan = _parser.Parse(json);
        ...
        // Assert
        markdown.Should().Contain($"| {ActionIcons.Add}{Nbsp}Add |")
            .And.Contain($"| {ActionIcons.Update}{Nbsp}Change |")
            .And.Contain($"| {ActionIcons.Replace}{Nbsp}Replace |")
            .And.Contain($"| {ActionIcons.Delete}{Nbsp}Destroy |")
            .And.Contain($"### 📦{Nbsp}Module: root");
    }

    [Test]
    public void Render_Header_Includes_Metadata_Line_When_Not_Hidden()
    {
        // Arrange
        ...
        // Assert
        markdown.Should().Contain("Generated by tfplan2md 2.0.0 (abc1234) on 2026-01-02 03:04:05 UTC | Terraform 1.14.0");
    }

    [Test]
    public void Render_Header_Omits_Metadata_Line_When_Hidden()
    {
        // Arrange
        var plan = _parser.Parse(File.ReadAllText("TestData/minimal-plan.json"));
        var metadata = new ReportMetadata("2.0.0", "abc1234", DateTimeOffset.Parse("2026-01-02T03:04:05Z", CultureInfo.InvariantCulture));
        ...
        // Assert
        markdown.Should().NotContain("Generated by tfplan2md 2.0.0 (abc1234) on 2026-01-02 03:04:05 UTC | Terraform 1.14.0");
    }
    ...
    public void Render_ValidPlan_ContainsActionSymbols()
    {
        ...
        markdown.Should().Contain($"{ActionIcons.Add}{Nbsp}azurerm_resource_group <b><code>main</code></b>")
            .And.Contain($"{ActionIcons.Update}{Nbsp}azurerm_key_vault <b><code>main</code></b>")
            .And.Contain($"{ActionIcons.Delete}{Nbsp}azurerm_virtual_network <b><code>old</code></b>")
            .And.Contain($"{ActionIcons.Replace}{Nbsp}azuredevops_git_repository <b><code>main</code></b>");
    }
    ...
    public void Render_SummaryTable_ShowsResourceTypeBreakdown()
    {
        ...
        markdown.Should().Contain($"| {ActionIcons.Add}{Nbsp}Add | 2 |");
        ...
        var addRowIndex = markdown.IndexOf($"| {ActionIcons.Add}{Nbsp}Add |", StringComparison.Ordinal);
    ...
    public void Render_EmptyPlan_ProducesValidMarkdown()
    {
        ...
        // Assert - With zero changes, should show "No changes" instead of empty table
        markdown.Should().Contain("## Summary")
            .And.Contain("Generated by tfplan2md")
            .And.Contain("Terraform 1.14.0")
            .And.Contain("No changes");

        // Should NOT contain the summary table
        markdown.Should().NotContain($"| {ActionIcons.Add}{Nbsp}Add | 0 |");

        // And resource changes section should NOT appear (redundant with summary)
    ...
    public void Render_EmptyPlan_ShowsNoChangesMessage()
    {
        ...
        // Assert - Resource Changes section should NOT appear for zero-changes plans
        // Summary shows "No changes" instead
    ...
    public void Render_MinimalPlan_HandlesNullAttributes()
    {
        ...
        markdown.Should().Contain($"{ActionIcons.Add}{Nbsp}null_resource <b><code>test</code></b>")
            .And.Contain("<details");
    }
    ...
    public void Render_CreateOnlyPlan_ShowsAllCreates()
    {
        ...
        // Assert
        markdown.Should().Contain($"{ActionIcons.Add}{Nbsp}azurerm_resource_group <b><code>main</code></b>")
            .And.Contain(ActionIcons.Add + Nbsp + "azurerm_storage_account <b><code>main</code></b>")
            .And.Contain("| " + ActionIcons.Add + Nbsp + "Add | 2 |")
    ...
    public void Render_DeleteOnlyPlan_ShowsAllDeletes()
    {
        ...
        // Assert
        markdown.Should().Contain($"{ActionIcons.Delete}{Nbsp}azurerm_storage_account <b><code>old</code></b>")
            .And.Contain($"{ActionIcons.Delete}{Nbsp}azurerm_resource_group <b><code>old</code></b>")
            .And.Contain($"{ActionIcons.Delete}{Nbsp}Destroy | 2");
    }
    ...
    public void Render_MultiModulePlan_HeadingsAndHierarchyAreCorrect()
    {
        ...
        {
            $"### 📦{Nbsp}Module: root",
            $"### 📦{Nbsp}Module: `module.network`",
            $"### 📦{Nbsp}Module: `module.network.module.subnet`",
            $"### 📦{Nbsp}Module: `module.app`",
            $"### 📦{Nbsp}Module: `module.app.module.database`"
        };
    ...
    public void RenderResourceChange_FirewallRuleCollection_ShowsAddedRules()
    {
        ...
        result.Should().NotBeNull();
        result.Should().Contain("allow-dns").And.Contain(ActionIcons.Add);
    ...
    public void RenderResourceChange_Nsg_UsesPlusIconForAddedRules()
    {
        ...
        // Assert
        result.Should().NotContain("➥").And.Contain($"| {ActionIcons.Add} |");
    }
    ...
    public void RenderResourceChange_FirewallRuleCollection_ShowsModifiedRules()
    {
        ...
        result.Should().NotBeNull();
        result.Should().Contain("allow-http").And.Contain(ActionIcons.Update);
    }
    ...
    public void RenderResourceChange_FirewallRuleCollection_ShowsRemovedRules()
    {
        ...
        result.Should().NotBeNull();
        result.Should().Contain("allow-ssh-old").And.Contain(ActionIcons.Delete);
    }
    ...
    public void RenderResourceChange_FirewallRuleCollection_Add_ShowsPerRuleTableAndCombinedAddresses()
    {
        ...
        normalized.Should().Contain(ActionIcons.Add).And.Contain("allow-dns");
    ...
    public void RenderResourceChange_FirewallRuleCollection_Modified_ShowsBeforeAfterTableAndCombinedAddresses()
    {
        ...
        result.Should().NotBeNull();
        var normalized = Normalize(result);
        normalized.Should().Contain(ActionIcons.Update).And.Contain("allow-http");
    ...
    public void RenderResourceChange_FirewallRuleCollection_Removed_ShowsPerRuleTable()
    {
        ...
        result.Should().NotBeNull();
        result.Should().Contain(ActionIcons.Delete).And.Contain("allow-ssh-old");
