...
**Related Feature:** [docs/features/020-markdown-html-rendering/specification.md](specification.md)
...
- ✅ Feature references included: "Related feature: docs/features/020-markdown-html-rendering/specification.md"
...
/// Related feature: docs/features/020-markdown-html-rendering/specification.md
/// </summary>
```
...
- ✅ Gold standard HTML files included for comparison:
  - `docs/features/020-markdown-html-rendering/comprehensive-demo-simple-diff.actual-gh-rendering.html`
  - `docs/features/020-markdown-html-rendering/comprehensive-demo.actual-azdo-rendering.html`
