# UAT Test Plan: Inline Relevant Attributes (Feature 138)
...
**Source Plan Path:** `docs/features/138-inline-relevant-attributes/uat-plan.json`

**Rendered Output Path:** `docs/features/138-inline-relevant-attributes/uat-plan.md`
...
tfplan2md docs/features/138-inline-relevant-attributes/uat-plan.json > docs/features/138-inline-relevant-attributes/uat-plan.md
```
