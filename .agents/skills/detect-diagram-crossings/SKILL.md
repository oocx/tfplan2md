...
```bash
python3 .agents/skills/detect-diagram-crossings/detect_crossings.py website/ai-workflow.html
```
...
```bash
node .agents/skills/detect-diagram-crossings/detect_all.js website/ai-workflow.html
```
...
```bash
cd .agents/skills/detect-diagram-crossings && npm install jsdom
```
