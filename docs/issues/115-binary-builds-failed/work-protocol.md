...
**Work Item:** `docs/issues/115-binary-builds-failed/`
...
- **Artifacts Produced:**
  - `docs/issues/115-binary-builds-failed/work-protocol.md`
  - `docs/issues/115-binary-builds-failed/analysis.md`
...
- **Artifacts Produced:**
  - `docs/issues/115-binary-builds-failed/release-notes.md`
