...
|---:|---|---|---|---|---|---|---|---|
| 1 | Update GPT-5.2-Codex references + benchmarks | Maintainer request (2026-01-17) | ✅ Done | New model release requires fresh benchmarks + guidance to keep agent recommendations accurate. | High | Med | Low | Updated `docs/ai-model-reference.md` and assessed agent recommendations. |
...
## Decision
Selected **Task 1** (per Maintainer direction).
