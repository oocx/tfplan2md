...
public class MarkdownFuzzTests
{
    ...
    /// </summary>
    [Theory]
    [InlineData("simple|pipe")]
    [InlineData("||double-pipe||")]
    [InlineData("|leading-pipe")]
    ...
    [InlineData("multiple_underscores_here")]
    ...
    [InlineData("[[double]]")]
    [InlineData("mixed[brackets(here)]")]
    ...
    /// </summary>
    [Theory]
    [InlineData(@"test|with*special_chars[and]brackets")]
    [InlineData(@"<html>&amp;\n\r\t")]
    [InlineData(@"all|*_[]()#`<>&\chars")]
