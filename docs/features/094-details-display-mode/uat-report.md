...
**Feature:** Feature 098 - CLI `--details` argument for controlling resource details display
**UAT Date:** 2026-02-19
...
- **Location:** `docs/features/094-details-display-mode/uat-artifact.md`
- **Size:** 333 lines
...
1. Run locally: `scripts/uat-run.sh docs/features/094-details-display-mode/uat-artifact.md`
...
1. **UAT Demo Artifact:** `docs/features/094-details-display-mode/uat-artifact.md`
   - 333 lines
...
2. **Complete Platform UAT:** Run `scripts/uat-run.sh docs/features/094-details-display-mode/uat-artifact.md` locally to validate rendering in real GitHub/Azure DevOps environments
3. **Test Edge Cases:**
