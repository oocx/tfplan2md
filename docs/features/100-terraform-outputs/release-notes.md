...
- **Feature specification**: [docs/features/100-terraform-outputs/specification.md](specification.md)
- **Architecture**: [docs/features/100-terraform-outputs/architecture.md](architecture.md)
- **Test plan**: [docs/features/100-terraform-outputs/test-plan.md](test-plan.md)
