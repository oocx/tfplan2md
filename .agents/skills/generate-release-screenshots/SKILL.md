...
Use the `website-visual-assets` skill (`.agents/skills/website-visual-assets/SKILL.md`) for:
...
- **Related skill**: `.agents/skills/website-visual-assets/SKILL.md` (for website screenshots)
