...
public class MarkdownRendererTests
{
    ...
    public void Render_ValidPlan_ContainsSummarySection()
    {
        ...
        markdown.Should().Contain("## Summary")
            .And.Contain($"➕{Nbsp}Add")
            .And.Contain($"🔄{Nbsp}Change")
            .And.Contain($"❌{Nbsp}Destroy");
    }
    ...
    public void Render_Summary_UsesNonBreakingSpaceBetweenIconAndLabel()
    {
        ...
        // Assert
        markdown.Should().Contain($"| ➕{Nbsp}Add |")
            .And.Contain($"| 🔄{Nbsp}Change |")
            .And.Contain($"| ♻️{Nbsp}Replace |")
            .And.Contain($"| ❌{Nbsp}Destroy |")
    ...
    public void Render_ValidPlan_ContainsActionSymbols()
    {
        ...
        markdown.Should().Contain($"➕{Nbsp}azurerm_resource_group <b><code>main</code></b>")
            .And.Contain($"🔄{Nbsp}azurerm_key_vault <b><code>main</code></b>")
            .And.Contain($"❌{Nbsp}azurerm_virtual_network <b><code>old</code></b>")
            .And.Contain($"♻️{Nbsp}azuredevops_git_repository <b><code>main</code></b>");
    }
    ...
    public void Render_SummaryTable_ShowsResourceTypeBreakdown()
    {
        ...
        markdown.Should().Contain($"| ➕{Nbsp}Add | 2 |");
        ...
        var addRowIndex = markdown.IndexOf($"| ➕{Nbsp}Add |", StringComparison.Ordinal);
    ...
    public void Render_SummaryTable_ShowsEmptyCellWhenNoActionResources()
    {
        ...
        // Assert
        markdown.Should().Contain($"| ❌{Nbsp}Destroy | 0 |");
    }
    ...
    public void Render_EmptyPlan_ProducesValidMarkdown()
    {
        ...
        markdown.Should().Contain("## Summary")
            ...
            .And.Contain($"| ➕{Nbsp}Add | 0 |")
            .And.Contain($"| 🔄{Nbsp}Change | 0 |")
            .And.Contain($"| ❌{Nbsp}Destroy | 0 |")
            .And.Contain("| **Total** | **0** | |");
    ...
    public void Render_MinimalPlan_HandlesNullAttributes()
    {
        ...
        markdown.Should().Contain($"➕{Nbsp}null_resource <b><code>test</code></b>")
            .And.Contain("<details");
    }
    ...
    public void Render_DeleteOnlyPlan_ShowsAllDeletes()
    {
        ...
        // Assert
        markdown.Should().Contain($"❌{Nbsp}azurerm_storage_account <b><code>old</code></b>")
            .And.Contain($"❌{Nbsp}azurerm_resource_group <b><code>old</code></b>")
            .And.Contain($"❌{Nbsp}Destroy | 2");
    }
