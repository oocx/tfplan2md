...
public class MarkdownRendererNsgTemplateTests
{
    ...
    public void Render_NsgUpdate_ShowsSemanticDiff()
    {
        ...
        result.Should().Contain("| 🔄 | allow-http | 110 | Inbound | Allow | Tcp | - *<br>+ 10.0.1.0/24, 10.0.2.0/24 | * | * | - 80<br>+ 8080 | - Allow HTTP<br>+ Allow alternate HTTP |");
        result.Should().Contain("| ❌ | allow-ssh | 120 | Inbound | Allow | Tcp | 10.0.0.0/8 | * | * | 22 | Legacy SSH access |");
    ...
    public void Render_NsgUpdate_SortsRulesByPriority()
    {
        ...
        var modifiedIndex = result.IndexOf("| 🔄 | allow-http | 110", StringComparison.Ordinal);
    ...
    public void Render_NsgUpdate_HandlesSingularAndPluralFields()
    {
        ...
        result.Should().Contain("| 🔄 | allow-http | 110 | Inbound | Allow | Tcp | - *<br>+ 10.0.1.0/24, 10.0.2.0/24 |");
