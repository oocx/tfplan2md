...
- **When you have multiple options to present**: Use the `askQuestions` tool with type="single-select" or "multi-select" instead of listing numbered options in your response
