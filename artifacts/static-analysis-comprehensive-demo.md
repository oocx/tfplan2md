...
Generated by tfplan2md 1.5.1 (7ffb2d4) on 2026-01-30 22:56:27 UTC | Terraform 1.14.0
...
**Status:** ⚠️ 9 high findings require attention
...
**Tools Used:** Checkov 3.2.490, tflint 0.60.0, tflint-errors 0.60.0, Trivy 0.69.0
...
| ⚠️ High | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0086<br/>Severity: HIGH<br/>Message: No public access block so not blocking public acls<br/>Link: [AWS-0086](https://avd.aquasec.com/misconfig/aws-0086)<br/>Rule: `AWS-0086` | [Details](https://avd.aquasec.com/misconfig/aws-0086) |

| ⚠️ High | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0087<br/>Severity: HIGH<br/>Message: No public access block so not blocking public policies<br/>Link: [AWS-0087](https://avd.aquasec.com/misconfig/aws-0087)<br/>Rule: `AWS-0087` | [Details](https://avd.aquasec.com/misconfig/aws-0087) |

| ⚠️ High | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0091<br/>Severity: HIGH<br/>Message: No public access block so not blocking public acls<br/>Link: [AWS-0091](https://avd.aquasec.com/misconfig/aws-0091)<br/>Rule: `AWS-0091` | [Details](https://avd.aquasec.com/misconfig/aws-0091) |

| ⚠️ High | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0092<br/>Severity: HIGH<br/>Message: Bucket has a public ACL: "public-read"<br/>Link: [AWS-0092](https://avd.aquasec.com/misconfig/aws-0092)<br/>Rule: `AWS-0092` | [Details](https://avd.aquasec.com/misconfig/aws-0092) |

| ⚠️ High | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0093<br/>Severity: HIGH<br/>Message: No public access block so not restricting public buckets<br/>Link: [AWS-0093](https://avd.aquasec.com/misconfig/aws-0093)<br/>Rule: `AWS-0093` | [Details](https://avd.aquasec.com/misconfig/aws-0093) |

| ⚠️ High | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0132<br/>Severity: HIGH<br/>Message: Bucket does not encrypt data with a customer managed key.<br/>Link: [AWS-0132](https://avd.aquasec.com/misconfig/aws-0132)<br/>Rule: `AWS-0132` | [Details](https://avd.aquasec.com/misconfig/aws-0132) |

| ⚠️ High | Ensure S3 bucket has MFA delete enabled<br/>Rule: `CKV_AWS_20` | [Details](https://docs.prismacloud.io/en/enterprise-edition/policy-reference/aws-policies/aws-general-policies/ensure-mfa-delete-enabled) |

| ⚠️ High | Ensure every security group and rule has a description<br/>Rule: `CKV_AWS_23` | [Details](https://docs.prismacloud.io/en/enterprise-edition/policy-reference/aws-policies/aws-networking-policies/networking-31) |

| ⚠️ High | Ensure no security groups allow ingress from 0.0.0.0:0 to port 80<br/>Rule: `CKV_AWS_260` | [Details](https://docs.prismacloud.io/en/enterprise-edition/policy-reference/aws-policies/aws-networking-policies/ensure-aws-security-groups-do-not-allow-ingress-from-00000-to-port-80) |

| ⚠️ Medium | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0090<br/>Severity: MEDIUM<br/>Message: Bucket does not have versioning enabled<br/>Link: [AWS-0090](https://avd.aquasec.com/misconfig/aws-0090)<br/>Rule: `AWS-0090` | [Details](https://avd.aquasec.com/misconfig/aws-0090) |

| ⚠️ Medium | terraform "required_version" attribute is required<br/>Rule: `terraform_required_version` | [Details](https://github.com/terraform-linters/tflint-ruleset-terraform/blob/v0.13.0/docs/rules/terraform_required_version.md) |

| ℹ️ Low | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0089<br/>Severity: LOW<br/>Message: Bucket has logging disabled<br/>Link: [AWS-0089](https://avd.aquasec.com/misconfig/aws-0089)<br/>Rule: `AWS-0089` | [Details](https://avd.aquasec.com/misconfig/aws-0089) |

| ℹ️ Low | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0094<br/>Severity: LOW<br/>Message: Bucket does not have a corresponding public access block.<br/>Link: [AWS-0094](https://avd.aquasec.com/misconfig/aws-0094)<br/>Rule: `AWS-0094` | [Details](https://avd.aquasec.com/misconfig/aws-0094) |

| ℹ️ Low | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0099<br/>Severity: LOW<br/>Message: Security group explicitly uses the default description.<br/>Link: [AWS-0099](https://avd.aquasec.com/misconfig/aws-0099)<br/>Rule: `AWS-0099` | [Details](https://avd.aquasec.com/misconfig/aws-0099) |

| ℹ️ Low | Artifact: main.tf<br/>Type: terraform<br/>Vulnerability AWS-0124<br/>Severity: LOW<br/>Message: Security group rule does not have a description.<br/>Link: [AWS-0124](https://avd.aquasec.com/misconfig/aws-0124)<br/>Rule: `AWS-0124` | [Details](https://avd.aquasec.com/misconfig/aws-0124) |
