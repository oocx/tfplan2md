...
✅ **`work-protocol.md` exists** at `docs/issues/090-no-op-parent-hides-child-changes/work-protocol.md`
...
**File:** `docs/issues/090-no-op-parent-hides-child-changes/release-notes.md`
...
**Documentation:**
- `docs/issues/090-no-op-parent-hides-child-changes/release-notes.md`
- `docs/issues/090-no-op-parent-hides-child-changes/analysis.md`
- `docs/issues/090-no-op-parent-hides-child-changes/work-protocol.md`
