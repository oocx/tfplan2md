...
/// </remarks>
public class MarkdownLintFixture : IAsyncLifetime
{
    /// <summary>
...
/// <summary>
/// xUnit collection definition for sharing the MarkdownLintFixture across tests.
/// </summary>
[CollectionDefinition(nameof(MarkdownLintCollection))]
public class MarkdownLintCollection : ICollectionFixture<MarkdownLintFixture>
{
}
