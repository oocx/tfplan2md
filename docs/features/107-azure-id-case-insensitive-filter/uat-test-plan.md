...
**Source Plan Path:** `docs/features/107-azure-id-case-insensitive-filter/uat-plan.json`

**Rendered Output Path:** `docs/features/107-azure-id-case-insensitive-filter/uat-plan.md`
...
tfplan2md docs/features/107-azure-id-case-insensitive-filter/uat-plan.json \
  --ignore-azure-id-case-changes \
  > docs/features/107-azure-id-case-insensitive-filter/uat-plan.md
```
