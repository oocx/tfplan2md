...
- **Feature specification**: [docs/features/086-azdo-principal-mapping/specification.md](specification.md)
- **Architecture**: [docs/features/086-azdo-principal-mapping/architecture.md](architecture.md)
- **Test plan**: [docs/features/086-azdo-principal-mapping/test-plan.md](test-plan.md)
