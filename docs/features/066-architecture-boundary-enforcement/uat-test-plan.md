...
- Architecture Design: `docs/features/066-architecture-boundary-enforcement/architecture.md`
- Test Plan: `docs/features/066-architecture-boundary-enforcement/test-plan.md`
