...
This test plan covers Feature 127 — a pure internal refactoring that eliminates duplicate code,
...
Reference: [`docs/features/119-code-simplification/specification.md`](specification.md)
