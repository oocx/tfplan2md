...
- `docs/features/007-built-in-templates/specification.md` - Marked as implemented
- `docs/features/007-built-in-templates/tasks.md` - Marked all tasks completed
- `docs/features/007-built-in-templates/test-plan.md` - Marked tests passing
