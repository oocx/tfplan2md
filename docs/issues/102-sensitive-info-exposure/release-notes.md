...
![AzApi create body with sensitive masking](https://raw.githubusercontent.com/oocx/tfplan2md/v1.26.1/docs/issues/102-sensitive-info-exposure/098-azapi-create.png)

### Variable Group: secret-to-public transition masked

![Variable Group sensitive/hidden masking](https://raw.githubusercontent.com/oocx/tfplan2md/v1.26.1/docs/issues/102-sensitive-info-exposure/098-vargroup.png)
