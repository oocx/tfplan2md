# UAT: `--details closed` Mode — All Resources Collapsed (Azure DevOps)

Expected: All `<details>` blocks render **collapsed** (no `open` attribute).

---

# Terraform Plan Report

Generated by tfplan2md 1.22.1 (d5e3b43) on 2026-02-19 19:50:25 UTC | Terraform 1.14.0
